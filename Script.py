class script(object):
   ...
   මගේ නම<a href='https://t.me/xandria_robot'>𝑿𝑨𝑵𝑫𝑹𝑰𝑨</a>, මට ඔයාට චිත්‍රපටි ලබාදෙන්න පුලුවන්, මට පුලුවන් දේවල් මාව ඔයාගේ සමූහයට එකතු කරගෙන බලන්න.😍</b> 
 
 ‎©️ＳＬＯＦＦＩＣＩＡＬ"""
    HELP_TXT = """𝙷𝙴𝚈 {}
𝙷𝙴𝚁𝙴 𝙸𝚂 𝚃𝙷𝙴 𝙷𝙴𝙻𝙿 𝙵𝙾𝚁 𝙼𝚈 𝙲𝙾𝙼𝙼𝙰𝙽𝙳𝚂."""
    ABOUT_TXT = """✯ MY NAME: 𝑿𝑨𝑵𝑫𝑹𝑰𝑨
✯ LIBRARY : PYROGRAM
✯ LANGUAGE : PYTHON 3
✯ DATA BASE : MONGODB
✯ BOT SERVER: RAILWAY
