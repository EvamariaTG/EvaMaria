...
from info import CHANNELS, ADMINS, AUTH_CHANNEL, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT, FORCE_TEXT, ALERT_1
...
async def start(client, message):
    ...
    if not files_:
        ...
        try:
            ...
            pass
        return await message.reply(ALERT_1)
    files = files_[0]
