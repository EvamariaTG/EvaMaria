...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('🎬 𝐌𝐨𝐯𝐢𝐞𝐬', url='https://t.me/Mallu_flix')
            ],
            [
                InlineKeyboardButton('⚙️ 𝐇𝐞𝐥𝐩', url=f"https://t.me/{temp.U_NAME}?start=help"),
            ]
            ]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🎬 𝐌𝐨𝐯𝐢𝐞𝐬', url='https://t.me/Malluflixofficial')
            ],[
