...
async def imdb_search(client, message):
    if ' ' in message.text:
        ...
        await k.edit('<b>Here is What I Found In My Database For Your Query  \n \n  ‌‌‌‌‎©️ＳＬＯＦＦＩＣＩＡＬ ­ </b>', reply_markup=InlineKeyboardMarkup(btn))
    else:
